      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '40px', flexWrap: 'wrap', gap: '20px' }}>
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#38bdf8' }}><Activity size={20} /><span>REAL-TIME AGENT DECISION</span></div>
          </div>
          <div style={{ textAlign: 'right', backgroundColor: 'rgba(30, 41, 59, 0.7)', padding: '10px 15px', borderRadius: '12px', border: `1px solid ${status.color}` }}>
        ...
        {/* --- เพิ่มส่วน Input สำหรับเพิ่มหุ้น --- */}
